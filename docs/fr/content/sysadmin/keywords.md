...
> Note: Il est possible avec **CMD + F** d'identifier tous les catalogues qui possédent un mot-clé (par exemple ***mot_cle_A***). Cette rechercher indiquera le nombre d'occurence des catalogues avec ce mot clé (en base de page, sur la droite).

![](assets/admin/admin_list_kw_default.png)
