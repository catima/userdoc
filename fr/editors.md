...
- [Affichage, ajout et modification de données](#affichage-ajout-et-modification-de-données)
  ...
  - [Ajout de données](#ajout-de-données)
    - [Données d'intégration de média](#données-dintégration-de-média)
    - [Données de type datation](#données-de-type-datation)
      - [Manuelle](#manuelle)
      - [Par ensemble de choix](#par-ensemble-de-choix)
